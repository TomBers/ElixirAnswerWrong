defmodule AnswerwrongWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Answerwrong.MyChannel do
        use AnswerwrongWeb, :channel
        alias Answerwrong.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :answerwrong,
                        pubsub_server: Answerwrong.PubSub
end
